...
public class OverlaidBarChartDemo extends ApplicationFrame {
  ...
  //      final CategoryLabelGenerator generator = new StandardCategoryLabelGenerator();
    ...
    //    renderer.setLabelGenerator(generator);
      ...
      //  ((MatrixSeries) dataset).update(1, 2, 4.5);
        plot.setDataset(3,(CategoryDataset) dataset);
        final XYBubbleRenderer renderer4 = new XYBubbleRenderer();
        plot.setRenderer(3,(CategoryItemRenderer) renderer4);
